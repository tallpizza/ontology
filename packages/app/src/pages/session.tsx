...
export default function Page() {
  ...
  const sessionPanelWidth = createMemo(() => (desktopReviewOpen() ? `${layout.session.width()}px` : "100%"))
  ...
  createEffect(() => {
    ...
    const wants = isDesktop() ? desktopReviewOpen() && activeTab() === "review" : store.mobileTab === "changes"
    if (!wants) return
